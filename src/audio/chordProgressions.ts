...
// data/chordProgressions.ts is allowed and deliberate — getDiatonicChordForDegree
// is data/'s only runtime-import reason this file exists outside src/data/,
// same as before; notes are no longer part of ChordItem.
 ...
 * scale's triad. Returns exactly one chord per step, with ids unique within
 * the returned array.
 *
