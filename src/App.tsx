...
export function App() {
  ...
  useSongModeSync();
  // Track solo is a session gesture, cleared by leaving the Loop layer or
  // changing the active loop — NOT by a tab or Pattern-segment change within
  // the Loop layer. One subscription owns that rule for every writer of the
  // layer/activeLoopId — see store/soloNav.ts.
  useSoloNavClear();
