...
| `pattern-grids.md` | Fixed-width storage, the three step layouts, span editing, custom Chord/Bass patterns, touch gestures (melody grid and custom-pattern lane) |
