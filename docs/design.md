...
2. **`components/vibes/`** — the Vibes Header tool and its picker modal: eight genre cards previewed on the current loop, kept on Use, undone on Cancel; the dice rerolls the previewed card.
