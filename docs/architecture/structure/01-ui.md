...
| 81 | Reharmonize + auto-reharmonize toggle | Accompaniment progression | `chord/ProgressionCard.tsx`, `chord/progressionHarmonize.ts` |
...
| 92 | Master FX: Reverb, Delay, Distortion, 3-band EQ, Compressor, Limiter (with GR meters), Monitor visualizer (mode switch, paused off-tab) | Master | `song/EffectsRackView.tsx:73-176,333-694` |
...
- `loop/ChordView.tsx` re-exports `applyKeyScaleChange`, `shouldClearReharmonizeIndicator`
  purely for `ChordView.test.tsx:287`.
