...
| 7 | Transport & music context | TransportBar (bottom) + Header (desktop) / MobileTopBar (mobile) | Play/stop, BPM, meter, metronome, playhead in TransportBar; key & scale in the frame's top bar |
