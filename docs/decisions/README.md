...
| [0025](0025-drive-token-in-closure.md) | The Google token lives only in a closure | `driveAuth.ts` holds the token; slices only mirror signed-in state; calls go through `withDriveToken`. |
